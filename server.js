...
app.post("/api/llm", async (req, res) => {
 ...
 "X-OpenRouter-Title": "Analisador de Mensagens corporativas",
 },
 body: JSON.stringify({
 model: MODEL,
 messages: [
 ...
 role: "system",
 content:  `
Você é um analisador de mensagens corporativas.

Classifique a mensagem em APENAS UMA das categorias:

- Urgente: exige ação imediata ou relata um problema crítico.
- Dúvida: busca informação ou esclarecimento.
- Solicitação: pede que alguém realize uma ação.
- Informativo: apenas comunica uma informação.
